...
# Armin Laschet
   ...
   optionspd = st.selectbox(
     'Following politicans of this party were analyzed. Pick one to see it!',
     ('- Select -', 'Olaf Scholz', 'Martin Schulz', 'Kevin Kühnert',  'Prof. Dr. Karl Lauterbach', 'Saskia Esken'))
...
# Olaf Scholz
   ...
   if optionspd == 'Martin Schulz':  
        st.write('You selected the politician:', optionspd + ".")
        
        st.write('•	From 1987 to 1998 Schulz was honorary mayor of Würselen')
        st.write('•	He was a member of the European Parliament from 1994 to 2017 and its president from 2012 to 2017')
        st.write('•	Schulz was a member of the federal executive committee and the party presidium of the SPD from 1999 to 2018.')
        st.write('•	From 2017 to 2018, he served as SPD party chairman')
        st.write('•	In December 2020, Schulz was elected chairman of the Friedrich Ebert Foundation, which has close ties to the SPD')
        st.write('Schulz ran as the SPDs candidate for chancellor in the 2017 federal election')
        st.write(' ')
        
        st.write('Time needed to process data: 04:35,93 min.')
        st.write('Number of tweets: 4119.')
        st.write(" ")
        st.write(" ")
        st.write("<h3 style='text-align: center;'>Twitter Data Analysis</h3>",unsafe_allow_html=True)
        ...
        st.write("<h4 style='text-align: center;'>1. Overview about the number of tweets over time</h4>",unsafe_allow_html=True)
        st.image("Analytics_Result/spd/schulz/os1.png", width=800)
        
        st.write("<h4 style='text-align: center;'>2. Get a first overview over the used words in the tweets.</h4>",unsafe_allow_html=True)
        st.image("Analytics_Result/spd/schulz/os2.png", width=800)
        ...
        st.write("<h4 style='text-align: center;'>5. Show Wordcloud with cleaned text</h4>",unsafe_allow_html=True)
        st.image("Analytics_Result/spd/schulz/os3.png", width=800)
        ...
        st.write("- A score above 0.15 is considered as a positive tweet")
        st.write("Show a Scatterplot for both results:")
        st.image("Analytics_Result/spd/schulz/os4.png", width=800)
        st.write("Show the percentage of each polarity as numbers and diagram:")
        st.image("Analytics_Result/spd/schulz/os5.png", width=800)
        st.image("Analytics_Result/spd/schulz/os6.png", width=800)
        st.write("Show the polarity and subjectivty of tweets over time:")
        st.image("Analytics_Result/spd/schulz/os7.png", width=800)
        
        st.write("<h4 style='text-align: center;'>8. Word related analysis</h4>",unsafe_allow_html=True)
        st.write("Show the amount of words per tweet:")
        st.image("Analytics_Result/spd/schulz/os8.png", width=800)
        st.write("Show a list of the most frequent words:")
        st.image("Analytics_Result/spd/schulz/os9.png", width=800)
        st.write("Show a list of the most frequent trigram ofwords:")
        st.image("Analytics_Result/spd/schulz/os10.png", width=800)
        
        st.write("<h4 style='text-align: center;'>9. Topic Analysis with LDA and Bertopic</h4>",unsafe_allow_html=True)
        st.write("Result of the LDA analysis:")
        st.image("Analytics_Result/spd/schulz/os11.png", width=800)
        st.write("Result of the Topic Modelling with Bertopic:")
        st.image("Analytics_Result/spd/schulz/os12.png", width=800)
        st.image("Analytics_Result/spd/schulz/os13.png", width=800)
        st.image("Analytics_Result/spd/schulz/os14.png", width=800)
        ...
        st.write("3. Save in a new column for each emotion the number of times the emotion appears in the tweet")
        st.write("Show the top 15 words for every emotion: ")
        st.image("Analytics_Result/spd/schulz/os15.png", width=800)
        st.image("Analytics_Result/spd/schulz/os16.png", width=800)
        st.image("Analytics_Result/spd/schulz/os17.png", width=800)
        ...
        st.write(" ")
        st.write("Shows the percentage of tweets with certain sentiment and if the tweet has a negative emotion:")
        st.image("Analytics_Result/spd/schulz/os18.png", width=800)
        st.write("Shows the percentage of tweets with certain sentiment and if the tweet has a positive emotion:")
        st.image("Analytics_Result/spd/schulz/os19.png", width=800)
        st.write("Show the percentage of tweets which share the emotion and sentiment:")
        st.image("Analytics_Result/spd/schulz/os20.png", width=800)
        st.image("Analytics_Result/spd/schulz/os21.png", width=800)        
...
# Janine Wissler
   ...
   optionfdp = st.selectbox(
     'Following politicans of this party were analyzed. Pick one to see it!',
     ('- Select -','Volker Wissing', 'Marie-Agnes Strack-Zimmermann', 'Daniel Föst', 'Katja Hessel', 'Dr. Lukas Köhler'))
...
# Marie-Agnes Strack-Zimmermann
   ...
   if optionfdp == 'Marie-Agnes Strack-Zimmermann':  
        st.write('You selected the politician:', optionfdp + ".")
        
        st.write('•	She is a member of the FDP federal executive committee and the executive committee of the FDP parliamentary group in the Bundestag')
        st.write('•	From 2008 to 2014, she was First Mayor and thus Deputy Mayor of the North Rhine-Westphalian state capital Düsseldorf')
        st.write('•	She has been a member of the German Bundestag since the 2017 Bundestag elections She has been Chairwoman of the Defense Committee of the German Bundestag since 2021')
        st.write('•	She has been Chairwoman of the Defense Committee of the German Bundestag since 2021')
        st.write(' ')
        
        st.write('Time needed to process data: 09:01,88 min.')
        st.write('Number of tweets: 8376.')
        st.write(" ")
        st.write(" ")
        st.write("<h3 style='text-align: center;'>Twitter Data Analysis</h3>",unsafe_allow_html=True)
        ...
        st.write("<h4 style='text-align: center;'>1. Overview about the number of tweets over time</h4>",unsafe_allow_html=True)
        st.image("Analytics_Result/fdp/zimmermann/zi1.png", width=800)
        
        st.write("<h4 style='text-align: center;'>2. Get a first overview over the used words in the tweets.</h4>",unsafe_allow_html=True)
        st.image("Analytics_Result/fdp/zimmermann/zi2.png", width=800)
        ...
        st.write("<h4 style='text-align: center;'>5. Show Wordcloud with cleaned text</h4>",unsafe_allow_html=True)
        st.image("Analytics_Result/fdp/zimmermann/zi3.png", width=800)
        ...
        st.write("- A score above 0.15 is considered as a positive tweet")
        st.write("Show a Scatterplot for both results:")
        st.image("Analytics_Result/fdp/zimmermann/zi4.png", width=800)
        st.write("Show the percentage of each polarity as numbers and diagram:")
        st.image("Analytics_Result/fdp/zimmermann/zi5.png", width=800)
        st.image("Analytics_Result/fdp/zimmermann/zi6.png", width=800)
        st.write("Show the polarity and subjectivty of tweets over time:")
        st.image("Analytics_Result/fdp/zimmermann/zi7.png", width=800)
        
        st.write("<h4 style='text-align: center;'>8. Word related analysis</h4>",unsafe_allow_html=True)
        st.write("Show the amount of words per tweet:")
        st.image("Analytics_Result/fdp/zimmermann/zi8.png", width=800)
        st.write("Show a list of the most frequent words:")
        st.image("Analytics_Result/fdp/zimmermann/zi9.png", width=800)
        st.write("Show a list of the most frequent trigram ofwords:")
        st.image("Analytics_Result/fdp/zimmermann/zi10.png", width=800)
        
        st.write("<h4 style='text-align: center;'>9. Topic Analysis with LDA and Bertopic</h4>",unsafe_allow_html=True)
        st.write("Result of the LDA analysis:")
        st.image("Analytics_Result/fdp/zimmermann/zi11.png", width=800)
        st.write("Result of the Topic Modelling with Bertopic:")
        st.image("Analytics_Result/fdp/zimmermann/zi12.png", width=800)
        st.image("Analytics_Result/fdp/zimmermann/zi13.png", width=800)
        st.image("Analytics_Result/fdp/zimmermann/zi14.png", width=800)
        ...
        st.write("3. Save in a new column for each emotion the number of times the emotion appears in the tweet")
        st.write("Show the top 15 words for every emotion: ")
        st.image("Analytics_Result/fdp/zimmermann/zi15.png", width=800)
        st.image("Analytics_Result/fdp/zimmermann/zi16.png", width=800)
        st.image("Analytics_Result/fdp/zimmermann/zi17.png", width=800)
        ...
        st.write(" ")
        st.write("Shows the percentage of tweets with certain sentiment and if the tweet has a negative emotion:")
        st.image("Analytics_Result/fdp/zimmermann/zi18.png", width=800)
        st.write("Shows the percentage of tweets with certain sentiment and if the tweet has a positive emotion:")
        st.image("Analytics_Result/fdp/zimmermann/zi19.png", width=800)
        st.write("Show the percentage of tweets which share the emotion and sentiment:")
        st.image("Analytics_Result/fdp/zimmermann/zi20.png", width=800)
        st.image("Analytics_Result/fdp/zimmermann/zi21.png", width=800)        

# Daniel Föst

   if optionfdp == 'Daniel Föst':  
        st.write('You selected the politician:', optionfdp + ".")
        
        st.write('•	Member of the FDP since 2005')
        st.write('•	2005 to 2009 Chairman of the Young Liberals Munich, 2010 to 2014 Chairman of the FDP Munich, since 2013 Secretary General of the FDP Bavaria, since 2014 Associate Member of the FDP Federal Executive Committee. 2008 to 2013 member of the Upper Bavarian District Council')
        st.write('•	Member of the Bundestag since 2017')
        st.write(' ')
        
        st.write('Time needed to process data: 15:24,34 min.')
        st.write('Number of tweets: 14210.')
        st.write(" ")
        st.write(" ")
        st.write("<h3 style='text-align: center;'>Twitter Data Analysis</h3>",unsafe_allow_html=True)
        st.write(" ")
        ...
        st.write("<h4 style='text-align: center;'>1. Overview about the number of tweets over time</h4>",unsafe_allow_html=True)
        st.image("Analytics_Result/fdp/foest/ko1.png", width=800)
        
        st.write("<h4 style='text-align: center;'>2. Get a first overview over the used words in the tweets.</h4>",unsafe_allow_html=True)
        st.image("Analytics_Result/fdp/foest/ko2.png", width=800)
        ...
        st.write("<h4 style='text-align: center;'>5. Show Wordcloud with cleaned text</h4>",unsafe_allow_html=True)
        st.image("Analytics_Result/fdp/foest/ko3.png", width=800)
        ...
        st.write("- A score above 0.15 is considered as a positive tweet")
        st.write("Show a Scatterplot for both results:")
        st.image("Analytics_Result/fdp/foest/ko4.png", width=800)
        st.write("Show the percentage of each polarity as numbers and diagram:")
        st.image("Analytics_Result/fdp/foest/ko5.png", width=800)
        st.image("Analytics_Result/fdp/foest/ko6.png", width=800)
        st.write("Show the polarity and subjectivty of tweets over time:")
        st.image("Analytics_Result/fdp/foest/ko7.png", width=800)
        
        st.write("<h4 style='text-align: center;'>8. Word related analysis</h4>",unsafe_allow_html=True)
        st.write("Show the amount of words per tweet:")
        st.image("Analytics_Result/fdp/foest/ko8.png", width=800)
        st.write("Show a list of the most frequent words:")
        st.image("Analytics_Result/fdp/foest/ko9.png", width=800)
        st.write("Show a list of the most frequent trigram ofwords:")
        st.image("Analytics_Result/fdp/foest/ko10.png", width=800)
        
        st.write("<h4 style='text-align: center;'>9. Topic Analysis with LDA and Bertopic</h4>",unsafe_allow_html=True)
        st.write("Result of the LDA analysis:")
        st.image("Analytics_Result/fdp/foest/ko11.png", width=800)
        st.write("Result of the Topic Modelling with Bertopic:")
        st.image("Analytics_Result/fdp/foest/ko12.png", width=800)
        st.image("Analytics_Result/fdp/foest/ko13.png", width=800)
        st.image("Analytics_Result/fdp/foest/ko14.png", width=800)
        ...
        st.write("3. Save in a new column for each emotion the number of times the emotion appears in the tweet")
        st.write("Show the top 15 words for every emotion: ")
        st.image("Analytics_Result/fdp/foest/ko15.png", width=800)
        st.image("Analytics_Result/fdp/foest/ko16.png", width=800)
        st.image("Analytics_Result/fdp/foest/ko17.png", width=800)
        ...
        st.write(" ")
        st.write("Shows the percentage of tweets with certain sentiment and if the tweet has a negative emotion:")
        st.image("Analytics_Result/fdp/foest/ko18.png", width=800)
        st.write("Shows the percentage of tweets with certain sentiment and if the tweet has a positive emotion:")
        st.image("Analytics_Result/fdp/foest/ko19.png", width=800)
        st.write("Show the percentage of tweets which share the emotion and sentiment:")
        st.image("Analytics_Result/fdp/foest/ko20.png", width=800)
        st.image("Analytics_Result/fdp/foest/ko21.png", width=800)        
