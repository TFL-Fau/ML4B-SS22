...
with st.expander("Before you start...", expanded=False):
    ...
    st.write('The Model used in this case was trained on 5000 Tweets of Saskia Esken. Accordingly, the results have the highest quality when trying to recognize the emotions of Saskia Eskens tweets.')
    ...
    st.write('This model could and should be expanded in the future by just training the model on a bigger set with mixed tweets of multiple politicians. But while it is only trained on a single politician, it provides its best use at recognizing the emotion of tweets that that politician is writing.')
